...
В файле **input.txt** содержится данная информация, где первая строка - количество ангаров, первое число каждой последующей строки - ширина, другое - длина:
```
3
10 20
50 90
...
При вводе данных из файла **input.txt** с указанным содержанием и запуске программы ожидается вывод на экран:  
...
Также результат будет записан в файл **output.txt**. Его содержимое эквивалентно выводу на экран.
